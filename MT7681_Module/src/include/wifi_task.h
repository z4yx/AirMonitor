...
VOID wifi_state_chg(UINT8 iStateMachine, UINT8 iSubState);
VOID wifi_state_machine(VOID);
VOID ws_init(OUT BOOLEAN *pb_enable);
VOID ws_smt_conn(OUT BOOLEAN *pb_enable);
VOID ws_scan(OUT BOOLEAN *pb_enable);
VOID ws_auth(OUT BOOLEAN *pb_enable);
VOID ws_assoc(OUT BOOLEAN *pb_enable);
