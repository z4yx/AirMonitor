...
#define     ENC28J60_SPI           ETH_SPI
#define     ENC28J60_BYTE_RW(x)    SPIWriteRead(ENC28J60_SPI, (x))
#define 	ENC28J60_CSL()		   GPIO_ResetBits(ETH_PORT, ETH_CS)
#define 	ENC28J60_CSH()		   GPIO_SetBits(ETH_PORT, ETH_CS)
