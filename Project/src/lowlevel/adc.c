...
void ADC_Channel_Config(GPIO_TypeDef* GPIOx, uint16_t pin, uint8_t channel, uint8_t rank)
{
	...
	ADC_RegularChannelConfig(ADC1, channel, rank, ADC_SampleTime_1Cycles5);
}

void ADC_DMA_Init(__IO uint16_t *ADCConvertedValues, uint32_t size)
{
